...
public class MainActivity extends AppCompatActivity {
    ...
    private DatabaseReference kurirRef;
    ...
    private void init() {
        ...
        kurirRef = FirebaseDatabase.getInstance().getReference(Common.KURIR_REF);
        ...
        builder.setNegativeButton("BATALKAN", (dialogInterface, i) -> dialogInterface.dismiss())
                .setPositiveButton("DAFTAR", (dialogInterface, i) -> {
                    if(TextUtils.isEmpty(edt_name.getText().toString())){
                        Toast.makeText(MainActivity.this, "Silahkan isi name kamu", Toast.LENGTH_SHORT).show();
                        return;
                    }
                    ...
                    serverUserModel.setActive(true);

                    dialog.show();

                    kurirRef.child(serverUserModel.getUid())
