...
public class UbahProdukActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dialog = new SpotsDialog.Builder().setContext(UbahProdukActivity.this).setCancelable(false).build();
        ...
        if(Common.selectedProduk.getGambar1() != null){
            Glide.with(getApplicationContext()).load(Common.selectedProduk.getGambar1()).into(imagePicker1);
        }
        if(Common.selectedProduk.getGambar2() != null){
            Glide.with(getApplicationContext()).load(Common.selectedProduk.getGambar2()).into(imagePicker2);
        }
        if(Common.selectedProduk.getGambar3() != null){
            Glide.with(getApplicationContext()).load(Common.selectedProduk.getGambar3()).into(imagePicker3);
        }
        if(Common.selectedProduk.getGambar4() != null){
            Glide.with(getApplicationContext()).load(Common.selectedProduk.getGambar4()).into(imagePicker4);
        }
        if(Common.selectedProduk.getGambar5() != null){
            Glide.with(getApplicationContext()).load(Common.selectedProduk.getGambar5()).into(imagePicker5);
        }
        ...
        imagePicker1.setOnClickListener(view -> {
            ...
            Toast.makeText(UbahProdukActivity.this, "Foto 1", Toast.LENGTH_SHORT).show();
        });
        ...
        imagePicker2.setOnClickListener(view -> {
            ...
            Toast.makeText(UbahProdukActivity.this, "Foto 2", Toast.LENGTH_SHORT).show();
        });
        ...
        imagePicker3.setOnClickListener(view -> {
            ...
            Toast.makeText(UbahProdukActivity.this, "Foto 3", Toast.LENGTH_SHORT).show();
        });
        ...
        imagePicker4.setOnClickListener(view -> {
            ...
            Toast.makeText(UbahProdukActivity.this, "Foto 4", Toast.LENGTH_SHORT).show();
        });
        ...
        imagePicker5.setOnClickListener(view -> {
            ...
            Toast.makeText(UbahProdukActivity.this, "Foto 5", Toast.LENGTH_SHORT).show();
        });
        ...
        edtNamaProduk.setText(Common.selectedProduk.getNama_produk());
        edtDeskripsiProduk.setText(Common.selectedProduk.getDeskripsi());
        edtHargaProduk.setText(Common.selectedProduk.getHarga_produk().toString());
        edtStokBarang.setText(Common.selectedProduk.getStok_produk().toString());
        edtBeratBarang.setText(Common.selectedProduk.getBerat_produk().toString());
        edtLebarBarang.setText(Common.selectedProduk.getLebar_produk().toString());
        edtPanjangBarang.setText(Common.selectedProduk.getPanjang_produk().toString());
        edtTinggiBarang.setText(Common.selectedProduk.getTinggi_produk().toString());
        edtOngkirPerkm.setText(Common.selectedProduk.getOngkir_perkm().toString());
        ...
        if(Common.selectedProduk.getPreorder()){
            swPreoder.setChecked(true);
        }
        if(Common.selectedProduk.getUnggulan()){
            swUnggulan.setChecked(true);
        }
        ...
        bSimpan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(edtNamaProduk.getText().toString().isEmpty() || edtHargaProduk.getText().toString().isEmpty()){
                    Toast.makeText(UbahProdukActivity.this, "Data Tidak Boleh Kosong", Toast.LENGTH_SHORT).show();
                }else{
                    SimpanDatabase();
                }
        ...
        categoryRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                ArrayAdapter<String> areasAdapter = new ArrayAdapter<String>(UbahProdukActivity.this, android.R.layout.simple_spinner_item, namaKategori);
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(UbahProdukActivity.this, ""+databaseError.getMessage().toString(), Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void SimpanDatabase(){
        ...
        //produkModel = Common.selectedProduk;
        FirebaseDatabase database = FirebaseDatabase.getInstance();


        produkModel.setId(Common.selectedProduk.getId());
        produkModel.setGambar1(Common.selectedProduk.getGambar1());
        produkModel.setGambar2(Common.selectedProduk.getGambar2());
        produkModel.setGambar3(Common.selectedProduk.getGambar3());
        produkModel.setGambar4(Common.selectedProduk.getGambar4());
        produkModel.setGambar5(Common.selectedProduk.getGambar5());
        ...
        if(listImageUri.size() > 0){
                                                            ...
                                                            if (finalUpload_count == (listImageUri.size() - 1)){
                                                                ...
                                                                FirebaseDatabase.getInstance()
                                                                        ...
                                                                        .addOnFailureListener(e -> {
                                                                            Toast.makeText(UbahProdukActivity.this, ""+e.getMessage(), Toast.LENGTH_SHORT).show();
                                                                        }).addOnCompleteListener(task -> {
                                                                    if(task.isSuccessful()){
                                                                        Toast.makeText(UbahProdukActivity.this, "Sukses!", Toast.LENGTH_SHORT).show();
                                                                        finish();
                                                                    }
                                                                });
                                                            }
            ...
            //Toast.makeText(UbahProdukActivity.this, "Silahkan tambahkan foto terlebih dahulu", Toast.LENGTH_SHORT).show();
        }
