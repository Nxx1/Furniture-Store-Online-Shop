...
import com.potensiutama.kusenstoreadmin.adapter.MyOrderAdapter;
import com.potensiutama.kusenstoreadmin.common.BottomSheetOrderFragment;
...
public class OrderFragment extends Fragment {
    ...
    private void updateTextCounter() {
        txt_order_filter.setText(new StringBuilder("Daftar Pesanan (")
