...
public class InformasiTokoModel {
    private String email,alamat_lengkap;
    private Long no_hp;
    private Double koordinatLat,koordinatLong;

    public InformasiTokoModel(String email, String alamat_lengkap, Long no_hp, Double koordinatLat, Double koordinatLong) {
        this.email = email;
