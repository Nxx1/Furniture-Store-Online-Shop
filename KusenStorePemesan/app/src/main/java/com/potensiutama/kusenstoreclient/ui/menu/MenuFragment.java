...
import com.potensiutama.kusenstoreclient.Adapter.MyCategoriesAdapter;
...
public class MenuFragment extends Fragment {
    ...
    private void initView() {
        ...
        dialog.show();
       // layoutAnimationController = AnimationUtils.loadLayoutAnimation(getContext(),R.anim.layout_from_left);
